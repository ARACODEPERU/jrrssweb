            ...
            <section class="pb-5 mb-4">
                <div class="container-lg"> 
                    ...
                    @foreach ($reuniones->slice(1, 4) as $key => $reunion)
                            <div class="col-md-6 p-3" data-aos="fade-up" data-aos-delay="{{ ($loop->iteration * 200) + 600 }}">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-9 text-center">
                                ...
                                <p class="text-color-light opacity-7 text-3 px-5 mx-5 mb-0"
                                    data-aos="fade-up" data-aos-delay="400">
                                    {{ $bible[2]->content ?? '' }}
                                </p>
                            </div>
            ...
            <section class="py-5 my-4"> 
                    ...
                    <div class="row">
                        @foreach ($ministerios->slice(1, 3) as $key => $ministerio)
                            <div class="col-md-4 p-2" data-aos="fade-left" data-aos-delay="{{ ($loop->iteration * 200) + 600 }}">
                                <div class="ih-item square colored effect8 scale_down">
                    ...
                    <div class="container"> 
                        <div class="row justify-content-center">
                            <div class="col-lg-9 text-center">
                                ...
                                <p class="text-color-light opacity-7 px-5 mx-5 mb-0 fs-5"
                                    data-aos="fade-up" data-aos-delay="400">
                                    {{ $gods_meeting[1]->content }}
                                </p>
                                <br>
                                <a href="{{ route('web_contacto') }}" class="" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 box-zoom p-4 text-center">
                            ...
                            <h4 class="line-height-1 text-transform-none font-weight-semibold"
                                data-aos="fade-up" data-aos-delay="400" style="font-size: 30px;">
                                {{ $difusion[0]->content }}
                            </h4>
                            <br>
                            <img class="mb-1 w-100 mt-n1"
                                data-aos="fade-up" data-aos-delay="600"
                                src="{{ asset('storage/' . ($difusion[2]->content ?? '')) }}" alt="Canal de difusión JRRSS">
                            <p class="text-3-5 pb-3 mb-1 mt-n3"
                                data-aos="fade-up"
                                data-aos-delay="800">
                                {{ $difusion[1]->content }}
                            </p>
                                
                            <a href="{{ $difusion[3]->content }}" class="" data-aos="fade-up" data-aos-delay="1000">
                        ...
                        <div class="col-md-4 box-zoom p-4 text-center">
                            ...
                            <img class="mb-1 w-100 mt-n2"
                                data-aos="fade-up" data-aos-delay="600"
                                src="{{ asset('storage/' . ($difusion[6]->content ?? '')) }}" alt="Canal de difusión RMNT">
                            <p class=" pb-3 mb-1 mt-n3"
                                    data-aos="fade-up"
                                data-aos-delay="800">
                                {{ $difusion[5]->content }}
                            </p>
                                
                            <a href="{{ $difusion[7]->content }}" class="" data-aos="fade-up" data-aos-delay="1000">
                                <button class="boton-fuego">
                                    <i class="fab fa-whatsapp fs-4"></i> &nbsp; ¡Canal de difusión!
                                </button>
                            </a>
