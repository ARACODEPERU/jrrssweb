...
@section('content')
    <div class="body">
        ...
        <div role="main" class="main">
            ...
            {{-- INICIO: PROPUESTA DE SLIDER MODERNO (SWIPER JS) --}}
            <div class="container-fluid p-0 mt-5">
                <div class="row">
                    <div class="col-12">
                        <h2 class="text-center mb-4" style="color: #333; font-weight: 700;">PROPUESTA DE NUEVO SLIDER (MODERNO)</h2>
                    </div>
                </div>
            </div>
            ...
            <style>
                .swiper-container-modern {
                    width: 100%;
                    height: 85vh; /* Altura inmersiva en escritorio */
                    position: relative;
                }
                ...
                .swiper-slide-modern img {
                    display: block;
                    width: 100%;
                    height: 100%;
                    object-fit: cover;
                    opacity: 0.85;
                    transition: transform 8s ease; /* Efecto Ken Burns lento */
                }
                ...
                .swiper-slide-active .modern-slider-title,
                .swiper-slide-active .modern-slider-subtitle {
                    opacity: 1;
                    transform: translateY(0);
                }
                ...
                @media (max-width: 768px) {
                    .modern-slider-title { font-size: 2rem; }
                    .modern-slider-subtitle { font-size: 1rem; }
                }
            </style>

            <div class="swiper swiper-container-modern mySwiperModern">
                <div class="swiper-wrapper">
                    @foreach ($sliders as $slide)
                        <div class="swiper-slide swiper-slide-modern">
                            <img src="{{ asset('storage/' . $slide->content) }}" alt="Slide JRRSS">
                            <div class="modern-slider-content">
                                {{-- Contenido simulado o dinámico si existiera en el objeto slide --}}
                                <h2 class="modern-slider-title">Bienvenido a Casa</h2>
                                <p class="modern-slider-subtitle">Una experiencia que transformará tu vida</p>
                            </div>
                        </div>
                    @endforeach
                </div>
                <div class="swiper-button-next swiper-button-next-modern"></div>
                <div class="swiper-button-prev swiper-button-prev-modern"></div>
                <div class="swiper-pagination"></div>
            </div>

            <script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
            <script>
                var swiperModern = new Swiper(".mySwiperModern", {
                    spaceBetween: 0,
                    effect: "fade",
                    loop: true,
                    speed: 1000,
            ...
            {{-- FIN: PROPUESTA DE SLIDER MODERNO --}}
