            ...
            <div class="container pt-4">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h3 class="text-secondary font-weight-bold text-capitalize text-7 mb-3">{{ $donador }}</h3>
                        <p>
                            Le extendemos nuestro agradecimiento por sumarse al sostenimiento del ministerio. Sabiendo que toda semilla que usted siembra traerá una gran cosecha, como dice su palabra:
                        </p>
                        <p>
