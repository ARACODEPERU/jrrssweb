...
<html lang="en">
	<head>
		...
		<link rel="apple-touch-icon" href="{{ asset('themes/jrrss/assets/img/apple-touch-icon.png') }}">
		...
		<link rel="stylesheet" href="{{ asset('themes/jrrss/assets/vendor/simple-line-icons/css/simple-line-icons.min.css') }}">
		<link rel="stylesheet" href="{{ asset('themes/jrrss/assets/vendor/owl.carousel/assets/owl.carousel.min.css') }}">
		<link rel="stylesheet" href="{{ asset('themes/jrrss/assets/vendor/owl.carousel/assets/owl.theme.default.min.css') }}">
